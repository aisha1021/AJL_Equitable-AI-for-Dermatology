...
# Use the correct EfficientNetB4 weights file
weights = '/kaggle/input/efficientnetb4-model/efficientnetb4_notop.h5'  # Update path for EfficientNetB4

# Load EfficientNetB4 without top layers
base_model = EfficientNetB4(weights=weights, include_top=False, input_tensor=input_layer)  # Change to EfficientNetB4
...
# Save history
with open('efficientnetb4-history.pkl', 'wb') as f:
    pickle.dump(history.history, f)

# Load history
with open('efficientnetb4-history.pkl', 'rb') as f:
...
model = load_model("/kaggle/input/efficientnetb3-model/efficientnetb3_model_with_finetuning_50_layers.h5")
...
# Save history
with open('efficientnetb4-finetuned-history.pkl', 'wb') as f:
    pickle.dump(history_fine.history, f)

# Load history
with open('efficientnetb4-finetuned-history.pkl', 'rb') as f:
...
# # Load the pre-trained model (with frozen layers)
from tensorflow.keras.models import load_model
model = load_model("/kaggle/input/efficientnetb4/efficientnetb4_model.h5")
