...
weights = '/kaggle/input/efficientnetb3/efficientnetb3_notop.h5'

# Load EfficientNetB3 without top layers
base_model = EfficientNetB3(weights=weights, include_top=False, input_tensor=input_layer)
...
# Save history
with open('efficientnetb3-history.pkl', 'wb') as f:
    pickle.dump(history.history, f)

# Load history
with open('efficientnetb3-history.pkl', 'rb') as f:
...
# Save history
with open('efficientnetb3-finetuned-history.pkl', 'wb') as f:
    pickle.dump(history_fine.history, f)

# Load history
with open('efficientnetb3-finetuned-history.pkl', 'rb') as f:
...
# # Load the pre-trained model (with frozen layers)
model = load_model("/kaggle/working/efficientnetb3_finetuned_model.h5")
...
# Save to CSV
submission_file = "submission_efficientnetb3.csv"
